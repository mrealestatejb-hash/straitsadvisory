...
(function(){
  ...
  var translations = {
    zh: {
      ...
      'cta_title': '开启您的马来西亚<br>置业之旅',
      'cta_subtitle': '无论是买房、卖房还是租房——与我们的团队交流，获得免费、无压力的咨询。',
      'Browse All 90+ Properties': '浏览90+精选房产',
      'Explore our handpicked developments across Johor Bahru, Kuala Lumpur, and Penang with filters, search, and detailed listings.': '探索我们在新山、吉隆坡和槟城精选的楼盘，提供筛选、搜索和详细信息。',
      'Johor Bahru': '新山',
      'Kuala Lumpur': '吉隆坡',
      'Penang': '槟城',
      ...
      // News page
      'news_badge': '★ 房产新闻',
      'news_hero_title': '市场<span class="gold">洞察</span>',
      'news_hero_subtitle': '马来西亚最新房产新闻、市场分析和投资见解。',
      'All': '全部',
      'news_filter_market': '市场动态',
      'news_filter_guides': '买家指南',
      'news_filter_launches': '新盘发布',
      'news_filter_policy': '政策法规',
      'news_coming_soon': '即将上线',
      'news_coming_soon_desc': '我们正在准备关于马来西亚房地产市场的深度文章。敬请期待市场动态、买家指南和投资分析。',
      // Compare page
      'Compare': '对比',
      'compare_badge': '\u2696 房产对比',
      'compare_hero_title': '对比 <span class="gold">房产</span>',
      'compare_hero_subtitle': '并排比较关键细节，做出明智的投资决策。',
    ...
    tw: {
      ...
      'Chat on WhatsApp': '在WhatsApp上聊天',
      'cta_title': '開啟您的馬來西亞<br>置業之旅',
      'cta_subtitle': '無論是買房、賣房還是租房——與我們的團隊交流，獲得免費、無壓力的諮詢。',
      'Browse All 90+ Properties': '瀏覽90+精選房產',
      'Explore our handpicked developments across Johor Bahru, Kuala Lumpur, and Penang with filters, search, and detailed listings.': '探索我們在新山、吉隆坡和檳城精選的樓盤，提供篩選、搜索和詳細資訊。',
      'Johor Bahru': '新山',
      'Kuala Lumpur': '吉隆坡',
      'Penang': '檳城',
      ...
      // News page
      'news_badge': '★ 房產新聞',
      'news_hero_title': '市場<span class="gold">洞察</span>',
      'news_hero_subtitle': '馬來西亞最新房產新聞、市場分析和投資見解。',
      'All': '全部',
      'news_filter_market': '市場動態',
      'news_filter_guides': '買家指南',
      'news_filter_launches': '新盤發布',
      'news_filter_policy': '政策法規',
      'news_coming_soon': '即將上線',
      'news_coming_soon_desc': '我們正在準備關於馬來西亞房地產市場的深度文章。敬請期待市場動態、買家指南和投資分析。',
      // Compare page
      'Compare': '比較',
      'compare_badge': '\u2696 房產比較',
      'compare_hero_title': '比較 <span class="gold">房產</span>',
      'compare_hero_subtitle': '並排比較關鍵細節，做出明智的投資決策。',
      'Select a property': '選擇房產',
      'Add Property': '添加房產',
      'Price (MYR)': '價格 (MYR)',
      'Price (SGD)': '價格 (SGD)',
      'Location': '位置',
    ...
    ms: {
      ...
      'cta_title': 'Mulakan Perjalanan Hartanah<br>Malaysia Anda',
      'cta_subtitle': 'Sama ada membeli, menjual atau menyewa — berbincanglah dengan pasukan kami untuk konsultasi percuma tanpa obligasi.',
      'Browse All 90+ Properties': 'Layari 90+ Hartanah',
      ...
      // News page
      'news_badge': '★ Berita Hartanah',
      'news_hero_title': 'Pandangan<span class="gold">Pasaran</span>',
      'news_hero_subtitle': 'Berita hartanah terkini, analisis pasaran dan pandangan pelaburan di seluruh Malaysia.',
      'All': 'Semua',
      'news_filter_market': 'Kemas Kini Pasaran',
      'news_filter_guides': 'Panduan Pembeli',
      'news_filter_launches': 'Pelancaran Baharu',
      'news_filter_policy': 'Dasar & Peraturan',
      'news_coming_soon': 'Akan Datang',
      'news_coming_soon_desc': 'Kami sedang menyediakan artikel berwawasan tentang pasaran hartanah Malaysia. Nantikan kemas kini pasaran, panduan pembeli dan analisis pelaburan.',
      // Compare page
      'Compare': 'Bandingkan',
      'compare_badge': '\u2696 Bandingkan Hartanah',
      'compare_hero_title': 'Bandingkan <span class="gold">Hartanah</span>',
      'compare_hero_subtitle': 'Bandingkan butiran utama secara bersebelahan untuk membuat keputusan pelaburan yang bijak.',
      'Select a property': 'Pilih hartanah',
      'Add Property': 'Tambah Hartanah',
      'Price (MYR)': 'Harga (MYR)',
      'Price (SGD)': 'Harga (SGD)',
      'Location': 'Lokasi',
      'Tenure': 'Tempoh Pegangan',
      'Bedrooms': 'Bilik Tidur',
      'Bathrooms': 'Bilik Mandi',
      'Size': 'Saiz',
      'Gross Yield': 'Hasil Kasar',
      'Distance to RTS': 'Jarak ke RTS',
      'Completion': 'Status Siap',
      'Developer': 'Pemaju',
    },
    ja: {
      'Buy': '購入',
      ...
      'cta_title': 'マレーシア不動産の<br>旅を始めましょう',
      'cta_subtitle': '購入、売却、賃貸のいずれでも——無料・無義務のご相談をどうぞ。',
      'Browse All 90+ Properties': '90以上の物件を閲覧',
      'Explore our handpicked developments across Johor Bahru, Kuala Lumpur, and Penang with filters, search, and detailed listings.': 'ジョホールバル、クアラルンプール、ペナンの厳選物件をフィルター、検索、詳細情報でご覧ください。',
      'Johor Bahru': 'ジョホールバル',
      ...
      // News page
      'news_badge': '★ 不動産ニュース',
      'news_hero_title': '市場<span class="gold">インサイト</span>',
      'news_hero_subtitle': 'マレーシア最新の不動産ニュース、市場分析、投資インサイト。',
      'All': 'すべて',
      'news_filter_market': '市場アップデート',
      'news_filter_guides': 'バイヤーガイド',
      'news_filter_launches': '新規ローンチ',
      'news_filter_policy': '政策・規制',
      'news_coming_soon': '近日公開',
      'news_coming_soon_desc': 'マレーシア不動産市場に関する記事を準備中です。市場アップデート、バイヤーガイド、投資分析をお楽しみに。',
      // Compare page
      'Compare': '比較',
      'compare_badge': '\u2696 物件比較',
      'compare_hero_title': '物件を<span class="gold">比較</span>',
      'compare_hero_subtitle': '主要な詳細を並べて比較し、賢い投資判断を。',
      'Select a property': '物件を選択',
      'Add Property': '物件を追加',
      'Price (MYR)': '価格 (MYR)',
      'Price (SGD)': '価格 (SGD)',
      'Location': '所在地',
    ...
    ko: {
      ...
      'cta_title': '말레이시아 부동산<br>여정을 시작하세요',
      'cta_subtitle': '매매, 임대 무엇이든 — 무료 상담을 위해 저희 팀과 상담하세요.',
      'Browse All 90+ Properties': '90개 이상의 매물 보기',
      'Explore our handpicked developments across Johor Bahru, Kuala Lumpur, and Penang with filters, search, and detailed listings.': '조호르바루, 쿠알라룸푸르, 페낭의 엄선된 개발지를 필터, 검색, 상세 정보로 탐색하세요.',
      'Johor Bahru': '조호르바루',
      'Kuala Lumpur': '쿠알라룸푸르',
      'Penang': '페낭',
      ...
      // News page
      'news_badge': '★ 부동산 뉴스',
      'news_hero_title': '시장<span class="gold">인사이트</span>',
      'news_hero_subtitle': '말레이시아 최신 부동산 뉴스, 시장 분석 및 투자 인사이트.',
      'All': '전체',
      'news_filter_market': '시장 업데이트',
      'news_filter_guides': '구매자 가이드',
      'news_filter_launches': '신규 런칭',
      'news_filter_policy': '정책 및 규정',
      'news_coming_soon': '곧 출시',
      'news_coming_soon_desc': '말레이시아 부동산 시장에 대한 통찰력 있는 기사를 준비 중입니다. 시장 업데이트, 구매자 가이드, 투자 분석을 기대해주세요.',
      // Compare page
      'Compare': '비교',
      'compare_badge': '\u2696 매물 비교',
      'compare_hero_title': '매물 <span class="gold">비교</span>',
      'compare_hero_subtitle': '주요 세부 사항을 나란히 비교하여 현명한 투자 결정을 내리세요.',
      'Select a property': '매물 선택',
      'Add Property': '매물 추가',
      'Price (MYR)': '가격 (MYR)',
      'Price (SGD)': '가격 (SGD)',
      'Location': '위치',
    ...
    th: {
      ...
      'cta_title': 'เริ่มต้นการเดินทาง<br>อสังหาริมทรัพย์มาเลเซีย',
      'cta_subtitle': 'ไม่ว่าจะซื้อ ขาย หรือเช่า — ปรึกษาทีมของเราฟรีโดยไม่มีข้อผูกมัด',
      'Browse All 90+ Properties': 'ดูอสังหาริมทรัพย์ 90+ รายการ',
      'Explore our handpicked developments across Johor Bahru, Kuala Lumpur, and Penang with filters, search, and detailed listings.': 'สำรวจโครงการที่คัดสรรใน Johor Bahru, Kuala Lumpur และ Penang พร้อมตัวกรอง ค้นหา และรายละเอียด',
      ...
      // News page
      'news_badge': '★ ข่าวอสังหาริมทรัพย์',
      'news_hero_title': 'ข้อมูล<span class="gold">ตลาด</span>',
      'news_hero_subtitle': 'ข่าวอสังหาริมทรัพย์ล่าสุด การวิเคราะห์ตลาด และข้อมูลการลงทุนในมาเลเซีย',
      'All': 'ทั้งหมด',
      'news_filter_market': 'อัปเดตตลาด',
      'news_filter_guides': 'คู่มือผู้ซื้อ',
      'news_filter_launches': 'เปิดตัวใหม่',
      'news_filter_policy': 'นโยบายและระเบียบ',
      'news_coming_soon': 'เร็วๆ นี้',
      'news_coming_soon_desc': 'เรากำลังเตรียมบทความเกี่ยวกับตลาดอสังหาริมทรัพย์มาเลเซีย รอติดตามการอัปเดตตลาด คู่มือผู้ซื้อ และการวิเคราะห์การลงทุน',
      // Compare page
      'Compare': 'เปรียบเทียบ',
      'compare_badge': '\u2696 เปรียบเทียบอสังหาริมทรัพย์',
      'compare_hero_title': 'เปรียบเทียบ<span class="gold">อสังหาริมทรัพย์</span>',
      'compare_hero_subtitle': 'เปรียบเทียบรายละเอียดสำคัญเคียงข้างกันเพื่อการตัดสินใจลงทุนที่ชาญฉลาด',
      'Select a property': 'เลือกอสังหาริมทรัพย์',
      ...
      'Distance to RTS': 'ระยะทางถึง RTS',
      'Completion': 'สถานะการก่อสร้าง',
      'Developer': 'ผู้พัฒนา',
    }
  };
