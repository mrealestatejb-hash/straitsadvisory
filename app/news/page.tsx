  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-16 md:pt-16">
        <div className="bg-gradient-to-br from-[#1a1a2e] to-[#2d2d5a] text-center text-white py-20 md:py-24 px-6 relative overflow-hidden">
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 text-center bg-gradient-to-br from-[#1a1a2e] to-[#2d2d5a]">
      ...
      {/* Footer */}
      <footer className="bg-[#1a1a2e] py-8 px-6 border-t border-white/[0.06] text-center">
