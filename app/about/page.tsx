  ...
  return (
    <div className="max-w-[480px] mx-auto bg-white/[0.06] rounded-xl overflow-hidden">
      ...
      <div className="p-5 flex flex-col gap-3 min-h-[280px]">
        ...
        <div className="max-w-[80%] px-4 py-2.5 rounded-2xl rounded-br-[4px] bg-[#c9a962] text-sm text-[#1a1a2e] font-medium leading-relaxed self-end">
      ...
      <div className="flex gap-2 px-4 py-3 border-t border-white/[0.08] bg-white/[0.03]">
        <input
          ...
          readOnly
        />
        <button className="px-4 py-2.5 bg-[#c9a962] text-[#1a1a2e] rounded-full font-semibold text-sm">
          Send
        </button>
      </div>
    </div>
...
export default function AboutPage() {
  ...
  return (
    <main>
      ...
      {/* Demo Section */}
      <section className="py-20 px-[clamp(20px,4vw,48px)]" style={{ background: '#1a1a2e' }}>
