    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="px-[clamp(20px,5vw,60px)] pt-7 max-w-[1200px] mx-auto">
        <div className="flex items-center gap-3.5 mb-3">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1a1a2e] to-[#2d2d5e] flex items-center justify-center text-lg text-white font-extrabold flex-shrink-0">
    ...
    <div className="bg-muted/30 border-t border-border py-12 px-[clamp(20px,5vw,60px)]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-[1200px] mx-auto">
        {similar.map((prop) => (
          ...
          >
            <div className="h-[140px] bg-gradient-to-br from-[#1a1a2e] to-[#16213e] flex items-center justify-center">
              {prop.image ? (
                <img
                  src={prop.image}
                  alt={prop.name}
